...
// (52 values — the only codes the server can put on the wire).
export const ERROR_CODES = [
  ...
  'USER_WITHDRAWAL_BLOCKED_PROPOSAL_DEPOSIT',
  'USER_WITHDRAWAL_BLOCKED_PROPOSAL',
  'USER_WITHDRAWAL_BLOCKED_OFFER',
  'USER_WITHDRAWAL_BLOCKED_REFUND',
  'USER_WITHDRAWAL_BLOCKED_PAYOUT',
  'VALIDATION_ERROR',
  'HTTP_ERROR',
] as const
